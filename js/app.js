...
window.addEventListener('load', function(){
  setTimeout(function(){
    try {
      var lastView = localStorage.getItem('inlop_last_view');
      if(lastView && (lastView === 'ops' || lastView === 'otif' || lastView === 'financiero')){
        console.log('→ Restaurando vista:', lastView);
        abrirVista(lastView);
      }
    } catch(e){
