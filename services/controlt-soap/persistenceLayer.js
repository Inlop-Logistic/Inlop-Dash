...
function toSoapPatch(viajeRow, sincronizadoEn) {
  return {
    ...
    soap_codigo_controlt_secundario:   viajeRow.codigo_controlt_secundario    ?? null,
    soap_codigo_empresa:               viajeRow.codigo_empresa                ?? null,
    soap_planificado_por:              viajeRow.planificado_por               ?? null,
    soap_codigo_ruta:                  viajeRow.codigo_ruta                   ?? null,
    soap_observaciones:                viajeRow.observaciones                 ?? null,
    soap_referencia_doc1:              viajeRow.referencia_doc1               ?? null,
    soap_referencia_doc2:              viajeRow.referencia_doc2               ?? null,
    soap_campos_auxiliares:            viajeRow.campos_auxiliares             ?? null,
    soap_rastreo_nueva_ui:             viajeRow.rastreo_nueva_ui              ?? null,
  };
}
...
function fromSoapRow(row, codigoViaje) {
  return {
    ...
    codigo_controlt_secundario:    row.soap_codigo_controlt_secundario    ?? null,
    codigo_empresa:                row.soap_codigo_empresa                ?? null,
    planificado_por:               row.soap_planificado_por               ?? null,
    codigo_ruta:                   row.soap_codigo_ruta                   ?? null,
    observaciones:                 row.soap_observaciones                 ?? null,
    referencia_doc1:               row.soap_referencia_doc1               ?? null,
    referencia_doc2:               row.soap_referencia_doc2               ?? null,
    campos_auxiliares:             row.soap_campos_auxiliares             ?? null,
    rastreo_nueva_ui:              row.soap_rastreo_nueva_ui              ?? null,
